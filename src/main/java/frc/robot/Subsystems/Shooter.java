...
public class Shooter extends SubsystemBase {
  private final TalonFX m_shooter, m_indexer, m_turret;
  private final TalonFXConfiguration m_shooterConfig, m_indexerConfig, m_turretConfig;

  private final CANcoder m_aimingEncoder;
  private final CANcoderConfiguration m_aimingEncoderConfig;

  private final ProfiledPIDController m_aimingController;
  ...
  public void configMotorDefaults() {
    ...
    m_turretConfig.ClosedLoopGeneral.ContinuousWrap = true;
